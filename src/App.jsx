    ...
    <div className="min-h-screen bg-slate-900">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-gray-300 hover:text-white transition-colors">Programs</a>
      ...
      <div className={`fixed inset-0 z-40 bg-slate-900/95 backdrop-blur-md transition-transform duration-300 ${
        ...
        <div className="flex flex-col items-center justify-center h-full space-y-8">
          <a href="#" className="text-white text-xl">Programs</a>
          <a href="#" className="text-white text-xl">Community</a>
